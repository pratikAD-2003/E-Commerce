...
import com.pycreation.e_commerce.databinding.FragmentOn2Binding
 ...
 * Use the [On2.newInstance] factory method to
...
class On2 : Fragment() {
    ...
    private lateinit var binding: FragmentOn2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOn2Binding.inflate(inflater, container, false)
        // Inflate the layout for this fragment
        binding.on2Prev.setOnClickListener {
            listener?.onChangeFragment(0)
        }

        binding.on2Next.setOnClickListener {
            listener?.onChangeFragment(2)
        }
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment On2.
         */
