...
class CartProductAdapter(
    ...
    private val onMoveToWishlist: (String) -> Unit,
    private val onIncrease: (String) -> Unit,
    private val onDecrease: (String) -> Unit
) :
    Adapter<CartProductAdapter.CartProductHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartProductHolder {
        val binding =
            CartProductItemBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    override fun onBindViewHolder(holder: CartProductHolder, position: Int) {
        ...
        holder.binding.moveToWishlistItem.setOnClickListener {
            onMoveToWishlist(currentProduct.productUid)
        }

        holder.binding.removeFromWishItem.setOnClickListener {
            onRemoveFromCart(currentProduct.productUid)
        }
